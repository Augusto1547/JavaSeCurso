...
public class MinhaThreadSoma implements Runnable{
	...
	//calculadora que me permitirá que todos as instâncias que forem referentes a MinhaThreadSoma tenha
	...
	public MinhaThreadSoma(String nome, int[] nums) {
		...
		//o nome pra depois pegar essa nome OBS// esse código eu mesmo que está em abaixo
...
//		t.start();
	...
	public void run() {//o método run vai chamar o método somaArray da classe calculadora
		...
		//parâmetros simbolizado pelo referência nums(com valores representados por um tipo array)
